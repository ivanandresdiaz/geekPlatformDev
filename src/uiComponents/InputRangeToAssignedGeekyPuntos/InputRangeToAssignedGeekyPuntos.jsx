...
import './inputRangeToAssignedGeekyPuntos.scss';
...
const InputRange = (props) => {
  ...
  const handleInputRangeChange = (evento) => {
    ...
    h4.current.innerHTML = `${Math.round(rangePercentage / 2)}<span></span>`;
    handleInputRangeChangeFather(evento.target.name, (evento.target.value / 2));
